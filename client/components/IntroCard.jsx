...
const IntroCard = (props) => {
  ...
  const introContentGuest = (
    <div className={classes}>
      ...
      <h6>
        → Begin by adding markers to the map. You'll need to log in if you want to start saving your lists.
      </h6>
      <h6>
        → You can <button type="button" className="greenLink" onClick={handleOpenLogin}>log in as a guest</button> if you just want to see how things work!
      </h6>
